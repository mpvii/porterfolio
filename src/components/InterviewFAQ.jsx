  ...
  return (
    <div className="px-4 py-12">
      <div className="mx-auto max-w-3xl">
        <h3 className="mb-4 text-white text-center text-3xl font-semibold">
          Questions You will likely Ask
        </h3>
        <Question title="Why should you hire me?">
          <p>
        ...
        <Question title="What can I bring to your team?">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque
            laboriosam neque reprehenderit saepe eius dolorum vel consequuntur
            perspiciatis ad vero.
...
const Question = ({ title, children, defaultOpen = false }) => {
  ...
  return (
    <motion.div
      ...
      className="border-b-[1px] border-b-indigo-400"
    >
      <button
      ...
      >
        <p className="text-white" ref={ref}>{children}</p>
      </motion.div>
    </motion.div>
  );
};
